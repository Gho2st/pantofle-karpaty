    ...
    <div className="max-w-7xl mx-auto p-4">
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-1/4">
          <h2 className="text-2xl font-medium mb-4">Twoje konto</h2>
          ...
          <button
            onClick={() => signOut()}
            className="mt-4 w-full text-left px-4 py-3 text-lg font-medium text-red-600 hover:bg-red-50 rounded-md transition"
          >
            Wyloguj się
          </button>
        </div>
